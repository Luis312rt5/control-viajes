...
var h = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-DWkAgceV-3GGXGOJ5.js")).iosTransitionAnimation : (await import("./p-BsBCoGa--OPI4LK2D.js")).mdTransitionAnimation;
};
var y = async (n3, e) => {
  await k(e, true);
...
@ionic/core/components/p-A3O24YmY.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-G6YBBSBP.js.map
